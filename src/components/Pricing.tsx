  ...
  return (
    <div
      ...
      className={`relative flex flex-col h-full bg-white rounded-2xl border ${
        isPopular
          ? "border-orderbot shadow-highlight"
          : "border-border/50 shadow-subtle-lg"
        ...
        <ul className="space-y-3 mb-6">
          {features.map((feature, i) => (
            <li key={i} className="flex items-start gap-2">
              <span className="text-orderbot mt-0.5">
                <Check size={16} />
              </span>
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
            ...
            include a fixed monthly fee plus a small percentage of each order.
          </p>
          <div
          ...
          {plans.map((plan, index) => (
            <PricingCard
              ...
              fixedFee={
                billingCycle === "yearly"
                  ? `$${
                      parseInt(plan.fixedFee.replace(/\D/g, "")) * 0.8 * 12
                    }/yr`
                  : plan.fixedFee
              }
