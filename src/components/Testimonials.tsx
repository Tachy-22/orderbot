...
const TestimonialCard = ({ quote, author, role, company, stars, index }: TestimonialCardProps) => {
...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote: "OrderBot has transformed how we handle orders. Our revenue increased by 35% in just two months!",
    ...
    {
      quote: "The AI chatbot is remarkably intuitive. Our customers love how easy it is to place orders now.",
      author: "Michael Chen",
    ...
    {
      quote: "Integration was seamless and the support team is always responsive. Best business decision we made this year.",
      author: "Priya Patel",
    ...
    <section className="section-padding bg-gradient-to-b from-white to-secondary/30">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
            Don't just take our word for it. See what our customers have to say about OrderBot.
          </p>
        </div>
